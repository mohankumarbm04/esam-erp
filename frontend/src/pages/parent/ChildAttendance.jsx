...
const ChildAttendance = () => {
  ...
  const fetchAttendance = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:5000/api/parent/child/${child.id}/attendance?semester=${selectedSem}`,
        {
      ...
      const mockAttendance = [
        { date: "2026-03-01", status: "present", subject: "CS301" },
        { date: "2026-03-02", status: "present", subject: "CS301" },
        { date: "2026-03-03", status: "present", subject: "CS301" },
        { date: "2026-03-01", status: "present", subject: "CS302" },
        { date: "2026-03-02", status: "absent", subject: "CS302" },
        { date: "2026-03-03", status: "present", subject: "CS302" },
        { date: "2026-03-01", status: "present", subject: "CS303" },
        { date: "2026-03-02", status: "present", subject: "CS303" },
        { date: "2026-03-03", status: "present", subject: "CS303" },
        { date: "2026-03-02", status: "present", subject: "CS351" },
      ];
  ...
  const handleDownloadReport = () => {
    alert(`Downloading attendance report for ${child?.name}`);
  };
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                  {attendanceData
                    .filter((a) => a.subject === subject.code)
                    .slice(0, 5)
                    .map((record, idx) => (
                      <div
                        key={idx}
